  ...
  if (dt_invoice_table.length) {
    var dt_invoice = dt_invoice_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="app-invoice-edit.html" class="dropdown-item">Редактировать</a>' +
      ...
      language: {
        ...
        search: '',
        searchPlaceholder: 'Найти конкурс'
      },
      // Buttons with Dropdown
      buttons: [
        {
          text: '<i class="ti ti-plus me-md-1"></i><span class="d-md-inline-block d-none">Создать конкурс</span>',
